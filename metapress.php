...
function metapress_init($post_types, $settings, $taxonomies) {
    ...
    add_action( 'save_post', 'metapress_save_meta_card_data' );
    add_action( 'add_meta_cardes', 'metapress_add_meta_card' );
 ...
 */
function metapress_meta_card_callback( $post ) {

    // Add an nonce field so we can check for it later.
    wp_nonce_field( 'metapress_meta_card', 'metapress_meta_card_nonce' );
 ...
 */
function metapress_add_meta_card() {
 ...
 */
function metapress_save_meta_card_data( $post_id ) {
    global $meta_fields;
    /*
    ...
    if ( ! isset( $_POST['metapress_meta_card_nonce'] ) ) {
        return;
    }

    // Verify that the nonce is valid.
    if ( ! wp_verify_nonce( $_POST['metapress_meta_card_nonce'], 'metapress_meta_card' ) ) {
        return;
    }
